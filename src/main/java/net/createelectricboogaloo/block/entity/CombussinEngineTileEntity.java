package net.createelectricboogaloo.block.entity;
...
public class CombussinEngineTileEntity extends RandomizableContainerBlockEntity implements IAnimatable, WorldlyContainer {
	public AnimationFactory factory = GeckoLibUtil.createFactory(this);
	private NonNullList<ItemStack> stacks = NonNullList.<ItemStack>withSize(0, ItemStack.EMPTY);
	private final LazyOptional<? extends IItemHandler>[] handlers = SidedInvWrapper.create(this, Direction.values());

	public CombussinEngineTileEntity(BlockPos pos, BlockState state) {
		super(CreateelectricboogalooModBlockEntities.COMBUSSIN_ENGINE.get(), pos, state);
	}
	...
	public void registerControllers(AnimationData data) {
		data.addAnimationController(new AnimationController<CombussinEngineTileEntity>(this, "controller", 0, this::predicate));
		data.addAnimationController(new AnimationController<CombussinEngineTileEntity>(this, "procedurecontroller", 0, this::procedurePredicate));
	}
	...
	public Component getDefaultName() {
		return Component.literal("combussin_engine");
	}
	...
	public Component getDisplayName() {
		return Component.literal("Combussin Engine");
	}
	...
	private final EnergyStorage energyStorage = new EnergyStorage(16000, 2000, 2000, 0) {
		@Override
